# Generated by Django 4.2.16 on 2024-12-28 21:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [django.contrib.postgres.indexes.HashIndex(fields=['first_name'], name='user_first_name_hash_idx'), django.contrib.postgres.indexes.HashIndex(fields=['last_name'], name='user_last_name_hash_idx'), models.Index(fields=['phone_number'], name='user_phone_number_idx')],
            },
        ),
